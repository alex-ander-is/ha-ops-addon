...
`;var hr=!1,ur=s=>s,zt=typeof document.head.style.touchAction=="string",jt="__polymerGestures",Bt="__polymerGesturesHandled",Ft="__polymerGesturesTouchAction",hs=25,us=5,pr=2,fr=["mousedown","mousemove","mouseup","click"],mr=[0,1,4,2],vr=(function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch{return!1}})();function Vt(s){return fr.indexOf(s)>-1}var ms=!1;(function(){try{let s=Object.defineProperty({},"passive",{get(){ms=!0}});window.addEventListener("test",null,s),window.removeEventListener("test",null,s)}catch{}})();function gr(s){if(!(Vt(s)||s==="touchend")&&zt&&ms&&hr)return{passive:!0}}var _r=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),br={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function G(s){let t=s.type;if(!Vt(t))return!1;if(t==="mousemove"){let i=s.buttons??1;return s instanceof window.MouseEvent&&!vr&&(i=mr[s.which]||0),!!(i&1)}return(s.button??0)===0}function yr(s){if(s.type==="click"){if(s.detail===0)return!0;let t=j(s);if(!t.nodeType||t.nodeType!==Node.ELEMENT_NODE)return!0;let e=t.getBoundingClientRect(),i=s.pageX,n=s.pageY;return!(i>=e.left&&i<=e.right&&n>=e.top&&n<=e.bottom)}return!1}var N={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function xr(s){let t="auto",e=gs(s);for(let i=0,n;i<e.length;i++)if(n=e[i],n[Ft]){t=n[Ft];break}return t}function vs(s,t,e){s.movefn=t,s.upfn=e,document.addEventListener("mousemove",t),document.addEventListener("mouseup",e)}function te(s){document.removeEventListener("mousemove",s.movefn),document.removeEventListener("mouseup",s.upfn),s.movefn=null,s.upfn=null}var gs=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:s=>s.composedPath&&s.composedPath()||[],Ut={},K=[];function wr(s,t){let e=document.elementFromPoint(s,t),i=e;for(;i?.shadowRoot&&!window.ShadyDOM;){let n=i;if(i=i.shadowRoot.elementFromPoint(s,t),n===i)break;i&&(e=i)}return e}function j(s){let t=gs(s);return t.length>0?t[0]:s.target}function Cr(s){let t=s.type,i=s.currentTarget[jt];if(!i)return;let n=i[t];if(!n)return;if(!s[Bt]&&(s[Bt]={},t.startsWith("touch"))){let o=s.changedTouches[0];if(t==="touchstart"&&s.touches.length===1&&(N.touch.id=o.identifier),N.touch.id!==o.identifier)return;zt||(t==="touchstart"||t==="touchmove")&&kr(s)}let r=s[Bt];if(!r.skip){for(let o=0,a;o<K.length;o++)a=K[o],n[a.name]&&!r[a.name]&&a.flow&&a.flow.start.indexOf(s.type)>-1&&a.reset&&a.reset();for(let o=0,a;o<K.length;o++)a=K[o],n[a.name]&&!r[a.name]&&(r[a.name]=!0,a[t](s))}}function kr(s){let t=s.changedTouches[0],e=s.type;if(e==="touchstart")N.touch.x=t.clientX,N.touch.y=t.clientY,N.touch.scrollDecided=!1;else if(e==="touchmove"){if(N.touch.scrollDecided)return;N.touch.scrollDecided=!0;let i=xr(s),n=!1,r=Math.abs(N.touch.x-t.clientX),o=Math.abs(N.touch.y-t.clientY);s.cancelable&&(i==="none"?n=!0:i==="pan-x"?n=o>r:i==="pan-y"&&(n=r>o)),n?s.preventDefault():Fe("track")}}function Ht(s,t,e){return Ut[t]?(Ar(s,t,e),!0):!1}function Ar(s,t,e){let i=Ut[t],n=i.deps,r=i.name,o=s[jt];o||(s[jt]=o={});for(let a=0,l,d;a<n.length;a++)l=n[a],!(_r&&Vt(l)&&l!=="click")&&(d=o[l],d||(o[l]=d={_count:0}),d._count===0&&s.addEventListener(l,Cr,gr(l)),d[r]=(d[r]||0)+1,d._count=(d._count||0)+1);s.addEventListener(t,e),i.touchAction&&Er(s,i.touchAction)}function qt(s){K.push(s),s.emits.forEach(t=>{Ut[t]=s})}function Sr(s){for(let t=0,e;t<K.length;t++){e=K[t];for(let i=0,n;i<e.emits.length;i++)if(n=e.emits[i],n===s)return e}return null}function Er(s,t){zt&&s instanceof HTMLElement&&Hi.run(()=>{s.style.touchAction=t}),s[Ft]=t}function Wt(s,t,e){let i=new Event(t,{bubbles:!0,cancelable:!0,composed:!0});if(i.detail=e,ur(s).dispatchEvent(i),i.defaultPrevented){let n=e.preventer||e.sourceEvent;n?.preventDefault&&n.preventDefault()}}function Fe(s){let t=Sr(s);t.info&&(t.info.prevent=!0)}qt({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){te(this.info)},mousedown(s){if(!G(s))return;let t=j(s),e=this,i=r=>{G(r)||(_e("up",t,r),te(e.info))},n=r=>{G(r)&&_e("up",t,r),te(e.info)};vs(this.info,i,n),_e("down",t,s)},touchstart(s){_e("down",j(s),s.changedTouches[0],s)},touchend(s){_e("up",j(s),s.changedTouches[0],s)}});function _e(s,t,e,i){t&&Wt(t,s,{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:i,prevent(n){return Fe(n)}})}qt({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(s){this.moves.length>pr&&this.moves.shift(),this.moves.push(s)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,te(this.info)},mousedown(s){if(!G(s))return;let t=j(s),e=this,i=r=>{let o=r.clientX,a=r.clientY;ps(e.info,o,a)&&(e.info.state=e.info.started?r.type==="mouseup"?"end":"track":"start",e.info.state==="start"&&Fe("tap"),e.info.addMove({x:o,y:a}),G(r)||(e.info.state="end",te(e.info)),t&&Rt(e.info,t,r),e.info.started=!0)},n=r=>{e.info.started&&i(r),te(e.info)};vs(this.info,i,n),this.info.x=s.clientX,this.info.y=s.clientY},touchstart(s){let t=s.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchmove(s){let t=j(s),e=s.changedTouches[0],i=e.clientX,n=e.clientY;ps(this.info,i,n)&&(this.info.state==="start"&&Fe("tap"),this.info.addMove({x:i,y:n}),Rt(this.info,t,e),this.info.state="track",this.info.started=!0)},touchend(s){let t=j(s),e=s.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:e.clientX,y:e.clientY}),Rt(this.info,t,e))}});function ps(s,t,e){if(s.prevent)return!1;if(s.started)return!0;let i=Math.abs(s.x-t),n=Math.abs(s.y-e);return i>=us||n>=us}function Rt(s,t,e){if(!t)return;let i=s.moves[s.moves.length-2],n=s.moves[s.moves.length-1],r=n.x-s.x,o=n.y-s.y,a,l=0;i&&(a=n.x-i.x,l=n.y-i.y),Wt(t,"track",{state:s.state,x:e.clientX,y:e.clientY,dx:r,dy:o,ddx:a,ddy:l,sourceEvent:e,hover(){return wr(e.clientX,e.clientY)}})}qt({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(s){G(s)&&(this.info.x=s.clientX,this.info.y=s.clientY)},click(s){G(s)&&fs(this.info,s)},touchstart(s){let t=s.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchend(s){fs(this.info,s.changedTouches[0],s)}});function fs(s,t,e){let i=Math.abs(t.clientX-s.x),n=Math.abs(t.clientY-s.y),r=j(e||t);!r||br[r.localName]&&r.hasAttribute("disabled")||(isNaN(i)||isNaN(n)||i<=hs&&n<=hs||yr(t))&&(s.prevent||Wt(r,"tap",{x:t.clientX,y:t.clientY,sourceEvent:t,preventer:e}))}var $r=s=>class extends s{static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}_disabledChanged(e){this._setAriaDisabled(e)}_setAriaDisabled(e){e?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")}click(){this.disabled||super.click()}},ie=k($r);var Mr=s=>class extends s{ready(){super.ready(),this.addEventListener("keydown",e=>{this._onKeyDown(e)}),this.addEventListener("keyup",e=>{this._onKeyUp(e)})}_onKeyDown(e){switch(e.key){case"Enter":this._onEnter(e);break;case"Escape":this._onEscape(e);break;default:break}}_onKeyUp(e){}_onEnter(e){}_onEscape(e){}},se=k(Mr);var ne=s=>class extends ie(se(s)){get _activeKeys(){return[" "]}ready(){super.ready(),Ht(this,"down",e=>{this._shouldSetActive(e)&&this._setActive(!0)}),Ht(this,"up",()=>{this._setActive(!1)})}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(e){return!this.disabled}_onKeyDown(e){super._onKeyDown(e),this._shouldSetActive(e)&&this._activeKeys.includes(e.key)&&(this._setActive(!0),document.addEventListener("keyup",i=>{this._activeKeys.includes(i.key)&&this._setActive(!1)},{once:!0}))}_setActive(e){this.toggleAttribute("active",e)}};var Gt=!1;window.addEventListener("keydown",()=>{Gt=!0},{capture:!0});window.addEventListener("mousedown",()=>{Gt=!1},{capture:!0});function be(){let s=document.activeElement||document.body;for(;s.shadowRoot&&s.shadowRoot.activeElement;)s=s.shadowRoot.activeElement;return s}function F(){return Gt}function _s(s){let t=s.style;if(t.visibility==="hidden"||t.display==="none")return!0;let e=window.getComputedStyle(s);return e.visibility==="hidden"||e.display==="none"}function Tr(s,t){let e=Math.max(s.tabIndex,0),i=Math.max(t.tabIndex,0);return e===0||i===0?i>e:e>i}function Ir(s,t){let e=[];for(;s.length>0&&t.length>0;)Tr(s[0],t[0])?e.push(t.shift()):e.push(s.shift());return e.concat(s,t)}function Kt(s){let t=s.length;if(t<2)return s;let e=Math.ceil(t/2),i=Kt(s.slice(0,e)),n=Kt(s.slice(e));return Ir(i,n)}function X(s){return s.checkVisibility?!s.checkVisibility({visibilityProperty:!0}):s.offsetParent===null&&s.clientWidth===0&&s.clientHeight===0?!0:_s(s)}function Or(s){return s.matches('[tabindex="-1"]')?!1:s.matches("input, select, textarea, button, object")?s.matches(":not([disabled])"):s.matches("a[href], area[href], iframe, [tabindex], [contentEditable]")}function ze(s){return s.getRootNode().activeElement===s}function Lr(s){if(!Or(s))return-1;let t=s.getAttribute("tabindex")||0;return Number(t)}function bs(s,t){if(s.nodeType!==Node.ELEMENT_NODE||_s(s))return!1;let e=s,i=Lr(e),n=i>0;i>=0&&t.push(e);let r=[];return e.localName==="slot"?r=e.assignedNodes({flatten:!0}):r=(e.shadowRoot||e).children,[...r].forEach(o=>{n=bs(o,t)||n}),n}function ys(s){let t=[];return bs(s,t)?Kt(t):t}var Pr=s=>class extends s{get _keyboardActive(){return F()}ready(){this.addEventListener("focusin",e=>{this._shouldSetFocus(e)&&this._setFocused(!0)}),this.addEventListener("focusout",e=>{this._shouldRemoveFocus(e)&&this._setFocused(!1)}),super.ready()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}focus(e){super.focus(e),e?.focusVisible!==!1&&this.setAttribute("focus-ring","")}_setFocused(e){this.toggleAttribute("focused",e),this.toggleAttribute("focus-ring",e&&this._keyboardActive)}_shouldSetFocus(e){return!0}_shouldRemoveFocus(e){return!0}},re=k(Pr);var Ve=s=>class extends ie(s){static get properties(){return{tabindex:{type:Number,reflectToAttribute:!0,observer:"_tabindexChanged",sync:!0},_lastTabIndex:{type:Number}}}_disabledChanged(e,i){super._disabledChanged(e,i),!this.__shouldAllowFocusWhenDisabled()&&(e?(this.tabindex!==void 0&&(this._lastTabIndex=this.tabindex),this.setAttribute("tabindex","-1")):i&&(this._lastTabIndex!==void 0?this.setAttribute("tabindex",this._lastTabIndex):this.tabindex=void 0))}_tabindexChanged(e){this.__shouldAllowFocusWhenDisabled()||this.disabled&&e!==-1&&(this._lastTabIndex=e,this.setAttribute("tabindex","-1"))}focus(e){(!this.disabled||this.__shouldAllowFocusWhenDisabled())&&super.focus(e)}__shouldAllowFocusWhenDisabled(){return!1}};var Dr=["mousedown","mouseup","click","dblclick","keypress","keydown","keyup"],oe=s=>class extends ne(Ve(re(s))){constructor(){super(),this.__onInteractionEvent=this.__onInteractionEvent.bind(this),Dr.forEach(e=>{this.addEventListener(e,this.__onInteractionEvent,!0)}),this.tabindex=0}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button"),this.__shouldAllowFocusWhenDisabled()&&this.style.setProperty("--_vaadin-button-disabled-pointer-events","auto")}_onKeyDown(e){super._onKeyDown(e),!(e.altKey||e.shiftKey||e.ctrlKey||e.metaKey)&&this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}__onInteractionEvent(e){this.__shouldSuppressInteractionEvent(e)&&e.stopImmediatePropagation()}__shouldSuppressInteractionEvent(e){return this.disabled}};var Xt=class extends oe(M(C(b(w(v))))){static get is(){return"vaadin-button"}static get styles(){return cs}static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}render(){return h`
    ...
    `}ready(){super.ready(),this._tooltipController=new O(this),this.addController(this._tooltipController)}__shouldAllowFocusWhenDisabled(){return window.Vaadin.featureFlags.accessibleDisabledButtons}};_(Xt);var xs=(s,t=s)=>m`
  :host {
...
`,Fs=[ye,js,Xr];var ii=class extends it(E(C(b(w(v))))){static get is(){return"vaadin-confirm-dialog-overlay"}static get styles(){return Fs}static get properties(){return{cancelButtonVisible:{type:Boolean,value:!1},rejectButtonVisible:{type:Boolean,value:!1}}}render(){return h`
...
`;var ai=class extends C(E(b(w(v)))){static get is(){return"vaadin-input-container"}static get styles(){return Gs}static get properties(){return{disabled:{type:Boolean,reflectToAttribute:!0},readonly:{type:Boolean,reflectToAttribute:!0},invalid:{type:Boolean,reflectToAttribute:!0}}}render(){return h`
      <slot name="prefix"></slot>
      <slot></slot>
      <slot name="suffix"></slot>
...
`;var di=class extends en(C(E(b(w(v))))){static get is(){return"vaadin-select-list-box"}static get styles(){return tn}static get properties(){return{orientation:{readOnly:!0}}}get _scrollerElement(){return this.shadowRoot.querySelector('[part="items"]')}render(){return h`
      <div part="items">
        <slot></slot>
      </div>
...
`;var pi=class extends oe(C(b(w(v)))){static get is(){return"vaadin-select-value-button"}static get styles(){return an}render(){return h`
      <div class="vaadin-button-container">
        <span part="label">
          <slot></slot>
        </span>
...
`)}],identifiers:["identifiers",c.identifiers,o=>(o.recovered_identifiers||[]).slice(0,3).map(a=>Array.isArray(a)?a.join(":"):String(a)).join(", ")],"original-name":["original-name",c.originalName,o=>o.original_name||""],source:["source",c.source,o=>[String(o.source_commit||"").slice(0,12),o.source_path].filter(Boolean).join(" ")]},e=["id","original-name","area","device"],i=["identifiers","name","entity-id","source"],n=(o,a)=>o.map(l=>{let[d,p]=t[l];return h`<div class=${`deleted-device-header-cell deleted-device-cell-${a} deleted-device-col-${l}`}>${p}</div>`}),r=(o,a,l)=>o.map(d=>{let[p,f,x]=t[d],y=String(x(a));return h`<div class=${`deleted-device-cell deleted-device-cell-${l} deleted-device-cell-${d} deleted-device-col-${d}`}>
  ...
  `}function fo(s){return s?.entity_id||s?.name||s?.id||""}function mi(s,t){return t?.length?h`<p class="deleted-entity-label">${s}</p><ul>${t.map(e=>h`<li>${fo(e)}</li>`)}</ul>`:g}function _n(s){if(!s||typeof s!="object")return h`<p>${c.noDeletedDevices}</p>`;let t=s.device_groups||[],e=s.orphan_entity_groups||[];return!t.length&&!e.length?h`<p>${c.noDeletedDevices}</p>`:h`
    <div class="deleted-devices-tree">
      ...
      ${t.map(i=>{let n=i.device||{},r=i.counts||{},o=[n.manufacturer,n.model,n.model_id].filter(Boolean).join(" / "),a=[n.label||n.id||c.deletedDevicesLabel,o,n.area].filter(Boolean).join(" \xB7 "),l=Number(r.deleted_entities||0),d=Number(r.active_entities||0),p=[(c.deletedDeviceGroupRemoveCount||"{deleted} entities to remove").replace("{deleted}",String(l))];d>0&&p.push((c.deletedDeviceGroupActiveCount||"{active} active entities").replace("{active}",String(d)));let f=p.join(", "),x=[String(n.source_commit||"").slice(0,12),n.source_path].filter(Boolean).join(" "),y=(n.identifiers||[]).slice(0,3).map(V=>Array.isArray(V)?V.join(":"):String(V)).join(", "),$=i.presentation_reason||{};return h`
