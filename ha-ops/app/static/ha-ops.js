...
`;var sn=!1,rn=s=>s,Ft=typeof document.head.style.touchAction=="string",Rt="__polymerGestures",Nt="__polymerGesturesHandled",jt="__polymerGesturesTouchAction",ls=25,ds=5,nn=2,on=["mousedown","mousemove","mouseup","click"],an=[0,1,4,2],ln=(function(){try{return new MouseEvent("test",{buttons:1}).buttons===1}catch{return!1}})();function Vt(s){return on.indexOf(s)>-1}var us=!1;(function(){try{let s=Object.defineProperty({},"passive",{get(){us=!0}});window.addEventListener("test",null,s),window.removeEventListener("test",null,s)}catch{}})();function dn(s){if(!(Vt(s)||s==="touchend")&&Ft&&us&&sn)return{passive:!0}}var cn=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),hn={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function K(s){let t=s.type;if(!Vt(t))return!1;if(t==="mousemove"){let i=s.buttons??1;return s instanceof window.MouseEvent&&!ln&&(i=an[s.which]||0),!!(i&1)}return(s.button??0)===0}function un(s){if(s.type==="click"){if(s.detail===0)return!0;let t=j(s);if(!t.nodeType||t.nodeType!==Node.ELEMENT_NODE)return!0;let e=t.getBoundingClientRect(),i=s.pageX,r=s.pageY;return!(i>=e.left&&i<=e.right&&r>=e.top&&r<=e.bottom)}return!1}var N={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function pn(s){let t="auto",e=fs(s);for(let i=0,r;i<e.length;i++)if(r=e[i],r[jt]){t=r[jt];break}return t}function ps(s,t,e){s.movefn=t,s.upfn=e,document.addEventListener("mousemove",t),document.addEventListener("mouseup",e)}function ee(s){document.removeEventListener("mousemove",s.movefn),document.removeEventListener("mouseup",s.upfn),s.movefn=null,s.upfn=null}var fs=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:s=>s.composedPath&&s.composedPath()||[],zt={},W=[];function fn(s,t){let e=document.elementFromPoint(s,t),i=e;for(;i?.shadowRoot&&!window.ShadyDOM;){let r=i;if(i=i.shadowRoot.elementFromPoint(s,t),r===i)break;i&&(e=i)}return e}function j(s){let t=fs(s);return t.length>0?t[0]:s.target}function mn(s){let t=s.type,i=s.currentTarget[Rt];if(!i)return;let r=i[t];if(!r)return;if(!s[Nt]&&(s[Nt]={},t.startsWith("touch"))){let o=s.changedTouches[0];if(t==="touchstart"&&s.touches.length===1&&(N.touch.id=o.identifier),N.touch.id!==o.identifier)return;Ft||(t==="touchstart"||t==="touchmove")&&vn(s)}let n=s[Nt];if(!n.skip){for(let o=0,l;o<W.length;o++)l=W[o],r[l.name]&&!n[l.name]&&l.flow&&l.flow.start.indexOf(s.type)>-1&&l.reset&&l.reset();for(let o=0,l;o<W.length;o++)l=W[o],r[l.name]&&!n[l.name]&&(n[l.name]=!0,l[t](s))}}function vn(s){let t=s.changedTouches[0],e=s.type;if(e==="touchstart")N.touch.x=t.clientX,N.touch.y=t.clientY,N.touch.scrollDecided=!1;else if(e==="touchmove"){if(N.touch.scrollDecided)return;N.touch.scrollDecided=!0;let i=pn(s),r=!1,n=Math.abs(N.touch.x-t.clientX),o=Math.abs(N.touch.y-t.clientY);s.cancelable&&(i==="none"?r=!0:i==="pan-x"?r=o>n:i==="pan-y"&&(r=n>o)),r?s.preventDefault():je("track")}}function Ht(s,t,e){return zt[t]?(gn(s,t,e),!0):!1}function gn(s,t,e){let i=zt[t],r=i.deps,n=i.name,o=s[Rt];o||(s[Rt]=o={});for(let l=0,a,d;l<r.length;l++)a=r[l],!(cn&&Vt(a)&&a!=="click")&&(d=o[a],d||(o[a]=d={_count:0}),d._count===0&&s.addEventListener(a,mn,dn(a)),d[n]=(d[n]||0)+1,d._count=(d._count||0)+1);s.addEventListener(t,e),i.touchAction&&bn(s,i.touchAction)}function Ut(s){W.push(s),s.emits.forEach(t=>{zt[t]=s})}function _n(s){for(let t=0,e;t<W.length;t++){e=W[t];for(let i=0,r;i<e.emits.length;i++)if(r=e.emits[i],r===s)return e}return null}function bn(s,t){Ft&&s instanceof HTMLElement&&Vi.run(()=>{s.style.touchAction=t}),s[jt]=t}function qt(s,t,e){let i=new Event(t,{bubbles:!0,cancelable:!0,composed:!0});if(i.detail=e,rn(s).dispatchEvent(i),i.defaultPrevented){let r=e.preventer||e.sourceEvent;r?.preventDefault&&r.preventDefault()}}function je(s){let t=_n(s);t.info&&(t.info.prevent=!0)}Ut({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){ee(this.info)},mousedown(s){if(!K(s))return;let t=j(s),e=this,i=n=>{K(n)||(ge("up",t,n),ee(e.info))},r=n=>{K(n)&&ge("up",t,n),ee(e.info)};ps(this.info,i,r),ge("down",t,s)},touchstart(s){ge("down",j(s),s.changedTouches[0],s)},touchend(s){ge("up",j(s),s.changedTouches[0],s)}});function ge(s,t,e,i){t&&qt(t,s,{x:e.clientX,y:e.clientY,sourceEvent:e,preventer:i,prevent(r){return je(r)}})}Ut({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(s){this.moves.length>nn&&this.moves.shift(),this.moves.push(s)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,ee(this.info)},mousedown(s){if(!K(s))return;let t=j(s),e=this,i=n=>{let o=n.clientX,l=n.clientY;cs(e.info,o,l)&&(e.info.state=e.info.started?n.type==="mouseup"?"end":"track":"start",e.info.state==="start"&&je("tap"),e.info.addMove({x:o,y:l}),K(n)||(e.info.state="end",ee(e.info)),t&&Bt(e.info,t,n),e.info.started=!0)},r=n=>{e.info.started&&i(n),ee(e.info)};ps(this.info,i,r),this.info.x=s.clientX,this.info.y=s.clientY},touchstart(s){let t=s.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchmove(s){let t=j(s),e=s.changedTouches[0],i=e.clientX,r=e.clientY;cs(this.info,i,r)&&(this.info.state==="start"&&je("tap"),this.info.addMove({x:i,y:r}),Bt(this.info,t,e),this.info.state="track",this.info.started=!0)},touchend(s){let t=j(s),e=s.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:e.clientX,y:e.clientY}),Bt(this.info,t,e))}});function cs(s,t,e){if(s.prevent)return!1;if(s.started)return!0;let i=Math.abs(s.x-t),r=Math.abs(s.y-e);return i>=ds||r>=ds}function Bt(s,t,e){if(!t)return;let i=s.moves[s.moves.length-2],r=s.moves[s.moves.length-1],n=r.x-s.x,o=r.y-s.y,l,a=0;i&&(l=r.x-i.x,a=r.y-i.y),qt(t,"track",{state:s.state,x:e.clientX,y:e.clientY,dx:n,dy:o,ddx:l,ddy:a,sourceEvent:e,hover(){return fn(e.clientX,e.clientY)}})}Ut({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(s){K(s)&&(this.info.x=s.clientX,this.info.y=s.clientY)},click(s){K(s)&&hs(this.info,s)},touchstart(s){let t=s.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchend(s){hs(this.info,s.changedTouches[0],s)}});function hs(s,t,e){let i=Math.abs(t.clientX-s.x),r=Math.abs(t.clientY-s.y),n=j(e||t);!n||hn[n.localName]&&n.hasAttribute("disabled")||(isNaN(i)||isNaN(r)||i<=ls&&r<=ls||un(t))&&(s.prevent||qt(n,"tap",{x:t.clientX,y:t.clientY,sourceEvent:t,preventer:e}))}var yn=s=>class extends s{static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}_disabledChanged(e){this._setAriaDisabled(e)}_setAriaDisabled(e){e?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled")}click(){this.disabled||super.click()}},te=w(yn);var xn=s=>class extends s{ready(){super.ready(),this.addEventListener("keydown",e=>{this._onKeyDown(e)}),this.addEventListener("keyup",e=>{this._onKeyUp(e)})}_onKeyDown(e){switch(e.key){case"Enter":this._onEnter(e);break;case"Escape":this._onEscape(e);break;default:break}}_onKeyUp(e){}_onEnter(e){}_onEscape(e){}},ie=w(xn);var se=s=>class extends te(ie(s)){get _activeKeys(){return[" "]}ready(){super.ready(),Ht(this,"down",e=>{this._shouldSetActive(e)&&this._setActive(!0)}),Ht(this,"up",()=>{this._setActive(!1)})}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(e){return!this.disabled}_onKeyDown(e){super._onKeyDown(e),this._shouldSetActive(e)&&this._activeKeys.includes(e.key)&&(this._setActive(!0),document.addEventListener("keyup",i=>{this._activeKeys.includes(i.key)&&this._setActive(!1)},{once:!0}))}_setActive(e){this.toggleAttribute("active",e)}};var Kt=!1;window.addEventListener("keydown",()=>{Kt=!0},{capture:!0});window.addEventListener("mousedown",()=>{Kt=!1},{capture:!0});function _e(){let s=document.activeElement||document.body;for(;s.shadowRoot&&s.shadowRoot.activeElement;)s=s.shadowRoot.activeElement;return s}function F(){return Kt}function ms(s){let t=s.style;if(t.visibility==="hidden"||t.display==="none")return!0;let e=window.getComputedStyle(s);return e.visibility==="hidden"||e.display==="none"}function wn(s,t){let e=Math.max(s.tabIndex,0),i=Math.max(t.tabIndex,0);return e===0||i===0?i>e:e>i}function Cn(s,t){let e=[];for(;s.length>0&&t.length>0;)wn(s[0],t[0])?e.push(t.shift()):e.push(s.shift());return e.concat(s,t)}function Wt(s){let t=s.length;if(t<2)return s;let e=Math.ceil(t/2),i=Wt(s.slice(0,e)),r=Wt(s.slice(e));return Cn(i,r)}function G(s){return s.checkVisibility?!s.checkVisibility({visibilityProperty:!0}):s.offsetParent===null&&s.clientWidth===0&&s.clientHeight===0?!0:ms(s)}function kn(s){return s.matches('[tabindex="-1"]')?!1:s.matches("input, select, textarea, button, object")?s.matches(":not([disabled])"):s.matches("a[href], area[href], iframe, [tabindex], [contentEditable]")}function Fe(s){return s.getRootNode().activeElement===s}function An(s){if(!kn(s))return-1;let t=s.getAttribute("tabindex")||0;return Number(t)}function vs(s,t){if(s.nodeType!==Node.ELEMENT_NODE||ms(s))return!1;let e=s,i=An(e),r=i>0;i>=0&&t.push(e);let n=[];return e.localName==="slot"?n=e.assignedNodes({flatten:!0}):n=(e.shadowRoot||e).children,[...n].forEach(o=>{r=vs(o,t)||r}),r}function gs(s){let t=[];return vs(s,t)?Wt(t):t}var Sn=s=>class extends s{get _keyboardActive(){return F()}ready(){this.addEventListener("focusin",e=>{this._shouldSetFocus(e)&&this._setFocused(!0)}),this.addEventListener("focusout",e=>{this._shouldRemoveFocus(e)&&this._setFocused(!1)}),super.ready()}disconnectedCallback(){super.disconnectedCallback(),this.hasAttribute("focused")&&this._setFocused(!1)}focus(e){super.focus(e),e?.focusVisible!==!1&&this.setAttribute("focus-ring","")}_setFocused(e){this.toggleAttribute("focused",e),this.toggleAttribute("focus-ring",e&&this._keyboardActive)}_shouldSetFocus(e){return!0}_shouldRemoveFocus(e){return!0}},re=w(Sn);var Ve=s=>class extends te(s){static get properties(){return{tabindex:{type:Number,reflectToAttribute:!0,observer:"_tabindexChanged",sync:!0},_lastTabIndex:{type:Number}}}_disabledChanged(e,i){super._disabledChanged(e,i),!this.__shouldAllowFocusWhenDisabled()&&(e?(this.tabindex!==void 0&&(this._lastTabIndex=this.tabindex),this.setAttribute("tabindex","-1")):i&&(this._lastTabIndex!==void 0?this.setAttribute("tabindex",this._lastTabIndex):this.tabindex=void 0))}_tabindexChanged(e){this.__shouldAllowFocusWhenDisabled()||this.disabled&&e!==-1&&(this._lastTabIndex=e,this.setAttribute("tabindex","-1"))}focus(e){(!this.disabled||this.__shouldAllowFocusWhenDisabled())&&super.focus(e)}__shouldAllowFocusWhenDisabled(){return!1}};var En=["mousedown","mouseup","click","dblclick","keypress","keydown","keyup"],ne=s=>class extends se(Ve(re(s))){constructor(){super(),this.__onInteractionEvent=this.__onInteractionEvent.bind(this),En.forEach(e=>{this.addEventListener(e,this.__onInteractionEvent,!0)}),this.tabindex=0}get _activeKeys(){return["Enter"," "]}ready(){super.ready(),this.hasAttribute("role")||this.setAttribute("role","button"),this.__shouldAllowFocusWhenDisabled()&&this.style.setProperty("--_vaadin-button-disabled-pointer-events","auto")}_onKeyDown(e){super._onKeyDown(e),!(e.altKey||e.shiftKey||e.ctrlKey||e.metaKey)&&this._activeKeys.includes(e.key)&&(e.preventDefault(),this.click())}__onInteractionEvent(e){this.__shouldSuppressInteractionEvent(e)&&e.stopImmediatePropagation()}__shouldSuppressInteractionEvent(e){return this.disabled}};var Gt=class extends ne($(x(b(y(v))))){static get is(){return"vaadin-button"}static get styles(){return as}static get properties(){return{disabled:{type:Boolean,value:!1,observer:"_disabledChanged",reflectToAttribute:!0,sync:!0}}}render(){return c`
...
`)}],identifiers:["identifiers",h.identifiers,a=>(a.recovered_identifiers||[]).slice(0,3).map(d=>Array.isArray(d)?d.join(":"):String(d)).join(", ")],"original-name":["original-name",h.originalName,a=>a.original_name||""],source:["source",h.source,a=>[String(a.source_commit||"").slice(0,12),a.source_path].filter(Boolean).join(" ")]},e=["id","original-name","area","device"],i=["identifiers","name","entity-id","source"],r=e.map(a=>t[a]),n=i.map(a=>t[a]),o=(a,d)=>c`
  ...
  `,l=(a,d,m)=>c`
    <div class=${`deleted-device-line deleted-device-line-${m}`}>
      ${a.map(([f,C,k])=>{let O=String(k(d));return c`<div class=${`deleted-device-cell deleted-device-cell-${f} deleted-device-col-${f}`}>
          ${["id","entity-id","identifiers","source"].includes(f)?c`<code>${O}</code>`:O}
        </div>`})}
    </div>
  `;return c`
    <div class="table-scroll">
      <div class="deleted-devices-table">
        ...
        ${s.map(a=>c`<div class="deleted-device-row">
          ${l(r,a,"primary")}
          ${l(n,a,"secondary")}
        </div>`)}
      </div>
